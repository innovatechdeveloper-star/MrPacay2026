...
console.log('🧺 CONVERTIDOR LOGOS DE ADVERTENCIA → ZPL ^GFA\n');
console.log('═══════════════════════════════════════════════════\n');
...
const LOGOS = [
    {
        input: './founds/warning-founds/lavar_max.png',
        output: './logo-lavar-max-zpl.js',
        nombre: 'LAVAR_MAX',
        descripcion: 'Lavar a temperatura máxima'
    },
    {
        input: './founds/warning-founds/no_plancharv2.png',
        output: './logo-no-planchar-zpl.js',
        nombre: 'NO_PLANCHAR',
        descripcion: 'No planchar v2'
    }
];
...
async function main() {
    console.log('🚀 Iniciando conversión de logos de advertencia...\n');
    
    for (const logo of LOGOS) {
        await convertirPngAZpl(logo);
    }
    ...
    console.log(`   const { LAVAR_MAX_ZPL } = require('./logo-lavar-max-zpl.js');`);
    console.log(`   const { NO_PLANCHAR_ZPL } = require('./logo-no-planchar-zpl.js');`);
}
