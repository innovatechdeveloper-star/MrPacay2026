...
console.log('🔪 TEST GUILLOTINA - Opción 1: ^MMC (Corte después de imprimir)\n');

const GODEX_IP = '192.168.1.35';
const GODEX_PORT = 9100;

// ZPL con comando de corte ^MMC
const testZPL = `^XA
^MMC
^PW354
^LL590
^CF0,40
^FO50,100^FDTEST CORTE 1^FS
^CF0,30
^FO50,150^FDCON GUILLOTINA^FS
^FO50,200^FD^MMC AL INICIO^FS
^XZ`;

console.log(`📄 ZPL con ^MMC:`);
console.log(testZPL);
