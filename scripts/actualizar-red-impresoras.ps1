# Script para actualizar configuración de red de impresoras
# Nueva red: 192.168.15.x
# Fecha: 5 de diciembre de 2025

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  ACTUALIZACIÓN DE RED - IMPRESORAS" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    if ($puertoViejoGodex) {
        ...
        Write-Host "  ✓ Puerto viejo eliminado" -ForegroundColor Green
    }
    ...
    Write-Host "  ✓ Puerto nuevo creado: IP_$nuevaRedGodex" -ForegroundColor Green
    ...
    Write-Host "  ✓ Godex G530 actualizada" -ForegroundColor Green
...
try {
    ...
    Write-Host "  ✓ Puerto nuevo creado: IP_$nuevaRedZebra" -ForegroundColor Green
    ...
    Write-Host "  ✓ Zebra ZD230 actualizada" -ForegroundColor Green
...
if ($pingGodex) {
    Write-Host "  ✓ Godex responde en la red" -ForegroundColor Green
} else {
    Write-Host "  ✗ Godex NO responde - Verifica que la impresora tenga la IP $nuevaRedGodex" -ForegroundColor Red
}
...
if ($pingZebra) {
    Write-Host "  ✓ Zebra responde en la red" -ForegroundColor Green
} else {
    Write-Host "  ✗ Zebra NO responde - Verifica que la impresora tenga la IP $nuevaRedZebra" -ForegroundColor Red
}
...
if (-not $pingGodex -or -not $pingZebra) {
    ...
    Write-Host "   Debes configurar las IPs físicas en las impresoras:" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "   GODEX G530:" -ForegroundColor Cyan
